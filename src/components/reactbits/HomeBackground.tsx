...
export default function HomeBackground() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // aurora blobs - React Bits inspired, more visible now
      ...
      g2.addColorStop(0, 'rgba(96,165,250,0.08)');
      g2.addColorStop(1, 'transparent');
      ctx.fillStyle = g2;
      ctx.fillRect(0, 0, cw, ch);

      // dot grid - React Bits Dot Grid, more visible
      ...
      // threads - React Bits Threads, more visible
