  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      if (Math.abs(y - prevY) > 0.5) {
        ...
        el.style.background = `radial-gradient(ellipse 70% 60% at 50% ${centerY}%, rgba(148,163,184,0.05) 0%, transparent 70%)`;
        prevY = y;
      }
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 50% 40% at 80% 70%, rgba(148,163,184,0.025) 0%, transparent 60%)',
        }}
      />
    </div>
  );
