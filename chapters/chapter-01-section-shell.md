...
8. **`ProjectsPreview.tsx`** — 3–4 featured project cards, "View all projects →" link to `/projects` (route stub exists from Chapter 0). Card component built here gets reused in the real `/projects` grid in Chapter 4 — build it well.
