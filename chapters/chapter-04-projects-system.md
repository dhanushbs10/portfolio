...
- Write at least 2–3 real projects as MDX files now, even in draft/rough form. This chapter isn't done with zero real project files — the whole point is proving the pipeline against real content, not a hypothetical schema.
