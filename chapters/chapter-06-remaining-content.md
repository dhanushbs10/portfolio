...
**Prerequisites:** Chapters 0–3 complete. (Chapters 4 and 5 don't need to be done first, but doing them first means you can reuse patterns — e.g. the MDX pipeline from Chapter 4 gets reused wholesale here.)
