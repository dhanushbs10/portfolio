...
**Prerequisites:** Chapters 0–3 complete (Chapter 4 not required first, order is flexible between 4 and 5, but don't attempt 5 before 0–3).
...
- [ ] Mobile (test at 375–414px) uses the scroll-snap sequence, not a broken/degraded version of the desktop camera pan.
